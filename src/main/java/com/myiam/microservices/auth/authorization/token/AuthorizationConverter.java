...
import com.myiam.microservices.auth.authentication.UserDto;
...
public class AuthorizationConverter {
    ...
    /**
     * 認可情報ドメイン(OAuth2Authorization) を Json にシリアライズ。
     *
    ...
    private JsonMapper builderSecurityJsonMapper() {
        ...
        bpt.allowIfSubType(UserDto.UserView.class);
